/* TypeScript doesn't work with React Native platform-specific file extensions
...
/* Compile time check that the android version and the version for other
   platforms are the same type */
declare var _test: typeof android;
declare var _test: typeof other;

// Export here so that the importing file can see the type.
// This is only for the TypeScript build process -
// React Native will import the correct file automatically
